...
-   We have been looking mostly to what's available within the R-language in general, and Seurat in particular. That means we skipped the Python alternative for SC analysis, [Scanpy](https://scanpy.readthedocs.io/); and its underlying data structure, ([AnnData](http://anndata.org/).)
...
-   It's a new framework, bringing `SingleCellExperiment` (not `SeuratObject`!) to the tidyverse idioms. Websites to explore:
