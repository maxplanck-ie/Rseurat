...
Since 2009, single-cell protocols are showing an increase in the throughput, going from tens to millions of cells in just over a decade. ([source](https://arxiv.org/abs/1704.01379))

Comparison of common scRNA-seq protocols ([source](https://doi.org/10.1146/annurev-biodatasci-080917-013452)). Abbreviations: cDNA, complementary DNA; DNA pol I, DNA polymerase I; FACS, fluorescence-activated cell sorting; PCR, polymerase chain reaction; RNase H, ribonuclease H; RT, reverse transcription; TSO, template-switching oligonucleotide.
...
Full-length transcript quantification will be more appropriate if one is interested in studying different isoforms. On the other hand, tagged protocols (e.g. UMIs) can detect the expression for a greater quantity of genes.
