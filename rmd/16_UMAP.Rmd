...
> ⌨🔥 Exercise: Would decreasing the number of PCs fed onto the clustering algorithm change our visualization? Would you say the results are 'better'? Distribute the room in 4-5 groups, and run the algorithms with 2, 5, 8, 12, and/ or 15 PCs. Strive to avoid common pitfalls!
