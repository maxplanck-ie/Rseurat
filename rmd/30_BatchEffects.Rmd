...
```{r out_of_the_box_umap, eval=FALSE, echo = FALSE,fig.width=12,fig.show='hold',fig.align='center',fig.cap=c("By technology.","By cell type.")}
my_cols = brewer.pal(panc@meta.data$tech %>% unique() %>% length(),"Dark2")
p1<-DimPlot(panc, reduction = "umap", group.by="tech", cols=alpha(my_cols,0.3))
...
panc_sub<-readRDS("datasets/preprocessed_rds/panc_sub.RDS")
