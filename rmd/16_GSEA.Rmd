...
> Only showing enrichments with odds ratio &ne; `1` & p-value < `0.05` (fdr). Tables are complete full list, and plots only show the top 25 pathways with biggest odds ratio, and color coding follows p-value (fdr). The combined score is computed as `ln(p)*z`, and is used to arrange values in the tables.
