...
HOMEWORK: Write specifications for each of the functions, what are their inputs types? What are their outputs types? Are all functions always returning the same output types?
