...
4. Add a `root_name` parameter of type `input: text`, and implement the following `save_XLSX()` to save all your DE tests results in a XLSX file:
...
5. Have a look at this research article that compares different DE testing methodologies/ package libraries for single-cell datasets: <https://www.nature.com/articles/nmeth.4612>
