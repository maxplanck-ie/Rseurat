...
```{r dependency_downgrade, eval=FALSE}
# This is only needed for those students that run the installation script as it was sent out by email.
remotes::install_version("matrixStats", version="1.1.0")

# another (better?) option would've been updating this one:
