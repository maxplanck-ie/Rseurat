...
> 🧭✨ Poll: What would happen if we used `ident.1 = 2`, and `ident.2 = 1` instead?
...
Apart from getting and visualizing marker genes, we would ultimately want to seee whether there are common functional themes in those marker lists. This will be covered in the next section.
