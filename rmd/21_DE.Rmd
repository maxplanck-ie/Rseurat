...
<div class="alert alert-dismissible alert-warning"><h4 class="alert-heading">
...
Try this: restart R (<code>Ctrl+Shift+F10</code>), and then execute <code>.libPaths(new = "/scratch/local/rseurat/pkg-lib-4.1.3")</code> in the Console directly (no code block this time).

<br />This may be run up to two times, we did had the unexpected experience were this was the case... 🤷
