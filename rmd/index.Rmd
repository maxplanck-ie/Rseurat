...
- Installation ('30)
- Sequencing protocols ('10)
- RMarkdown = YAML + Markdown + Code ('5)
- Futureverse ('5)
- First half of the Pipeline
  - QC, Filter, Normalization, Scaling, PCA. ('60)
  - BREAK ('10), after it, 2h gone by.
  - Clustering ('45)
  - Exercises ('15), we may not do all 5!
- Odds ratio, Enrichment Analysis ('45)

## 2nd Day

- Any questions from past day or its exercises?
- UMAP ('20)
- DE (3h) + incl. exercises
- Viz ('20)
