...
Due to the mathematical difference, each method has different parameters to control this. For t-SNE, it’s the perplexity. For UMAP, it’s the number of neighbors (n_neighbor). The two parameters are what we should take care of when optimizing our data visualization. 
