...
```{r mt_categories, out.width="32%", out.height="32%", fig.show='hold', fig.align="center"}
lapply(c("Low", "Medium", "High"), function(level) {
  subset(pbmc, mt.categories == level) %>%
         VlnPlot(features = "percent.mt") +
    labs(title=level) + NoLegend()
})
```
