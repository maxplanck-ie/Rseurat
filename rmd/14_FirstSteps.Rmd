...
> 🧭✨ Poll:  How many cells have less than 2000 counts in total (summed over all genes)?  Hint: use `colSums`.
...
> 🧭✨ Polls:
> 1. Which are the 3 most highly variable genes? Hint: use `VariableFeatures()`.
