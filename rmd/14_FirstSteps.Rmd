...
> ⌨🔥 Exercise:  
Plot the histogram of counts for the previous top gene over all cells
...
> ⌨🔥 Exercise: In cell "AAATTCGATTCTCA-1", how many reads map to gene "ACTB"? Hint: subset the assay data, `pbmc@assays$RNA`.
...
> ⌨🔥 Exercise:  Which is the default value of the parameter `K` that Seurat uses? Hint: `help` yourselves by reading the docs!
