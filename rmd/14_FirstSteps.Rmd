...
https://PollEv.com/multiple_choice_polls/K3MKnt5OsuhryxPCb4J1I/respond
> Hint: use `VariableFeatures()`.
>
> What's the variance of the gene `PYCARD`?
https://PollEv.com/multiple_choice_polls/awTn4BDUkLDbWKofpLqHZ/respond
> hint: use `HVFInfo()`.
...
https://PollEv.com/multiple_choice_polls/fi9Z4jqXU22sFf2P0SDeq/respond
...
https://PollEv.com/multiple_choice_polls/mb6W3JcgNnHmh3fllFhQ7/respond
...
For that, we'll use the community search algorithm for graphs called Leiden.
You can read more about it [here](https://www.nature.com/articles/s41598-019-41695-z).
...
https://PollEv.com/multiple_choice_polls/NgrSgdYpoUBVZ2qInZeGW/respond
